...
class Flat(models.Model):
    ...
    owners_phonenumber = PhoneNumberField('Номер владельца', blank=True)
    ...
    likes = models.ManyToManyField("Flat", blank=True, related_name="liked_flats", verbose_name='Кто лайкнул')
